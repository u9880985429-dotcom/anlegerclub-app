...
export const notificationsForUser: NotificationItem[] = [
  ...
  },
  {
    ...
    title: "Mira Schulz hat dich erwähnt",
...
export const auditLog: AuditEntry[] = [
  ...
  { id: "al_3", actorId: "u_mira", actorName: "Mira Schulz (MOD)", action: "POST_HIDE", entity: "Post", entityId: "p_c_starter_4", createdAt: "2026-04-21T11:30:00Z" },
